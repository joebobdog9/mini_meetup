    ...
    return (
        <div className="map-container" >
           <GoogleMap
            ...
            <PetEvent lat={this.props.userLatRelay} lng={this.props.userLongRelay} zoom={12} />
            <Heights lat={29.777070} lng={-95.435494}/>
            <CentralMarket lat={29.772854} lng={-95.298758}/>
            <Hobby lat={29.654107} lng={-95.276614}/>
            <Spain lat={41.385064} lng={2.173403}/>
...
class CentralMarket extends React.Component {
  constructor(props) {
    super(props);
    this.stylez = {
          position: 'absolute',
  ...
  _handleClick(e){
      e.preventDefault()
      window.location.hash = '#/eventDetail/VgijeBg6Ya'
  }
...
class Heights extends React.Component {
  constructor(props) {
    super(props);
    this.stylez = {
          position: 'absolute',
...
class Hobby extends React.Component {
  ...
  _handleClick(e){
      e.preventDefault()
      window.location.hash = '#/eventDetail/eUPZH0T6vf'
  }
...
class Spain extends React.Component {
  ...
  _handleClick(e){
      e.preventDefault()
      window.location.hash = '#/eventDetail/ePP3D5Shr3'
  }
